...
export default function MissingPersonsPage() {
  ...
  useEffect(() => {
    const handler = ({ action, person }) => {
      ...
      if (action === 'created') setItems((prev) => [person, ...prev.filter((p) => p.id !== person.id)]);
